        ...
        >
            ...
            <el-input-number
              ...
              @update:model-value="
                $emit('update:attributes', {
                  ...attributes,
                  context_participation_length: $event ?? 0,
                })
              "
              :min="0"
              :step="1"
          ...
          <el-form-item>
            ...
            <el-switch
              ...
              @update:model-value="
                $emit('update:attributes', { ...attributes, is_collapsed: Boolean($event) })
              "
            />
          </el-form-item>
          <el-form-item>
            ...
            <el-switch
              ...
              @update:model-value="
                $emit('update:attributes', { ...attributes, is_minimal: Boolean($event) })
              "
            />
          </el-form-item>
        </template>
