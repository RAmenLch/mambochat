export default {
  ...
  global: {
    ...
    checkpointCleanup: 'Clean Up Checkpoints Database',
    cleanupTip:
      'Reclaim disk space occupied by deleted sessions. New conversations are temporarily unavailable during cleanup; run when idle.',
    cleanupBtn: 'Clean Up Now',
    cleanupReclaimable: 'Approx. {size} reclaimable',
    cleanupDone: 'Cleanup finished, reclaimed {size}',
    cleanupSkipped: 'Nothing to clean up',
    cleanupFailed: 'Cleanup failed',
    cleanupTriggerFailed: 'Failed to trigger cleanup, please retry later',
