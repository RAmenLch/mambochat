export default {
  ...
  skill: {
    ...
    repoPlaceholder: 'URL or owner/repo or npx skills add owner/repo',
    ...
    conflictTitle: 'Duplicate Skill Detected',
    conflictMessage: 'The following skill(s) already exist: {names}. Overwriting will delete the existing content and re-import.',
