export default {
  ...
  // Multimodal Describer
  multimodalDescriber: 'Multimodal Describer',
  multimodalDescriberEnable: 'Enable Multimodal Describer',
  multimodalDescriberEnableDesc: 'Give the main model additional multimodal understanding. Modalities natively supported by the main model pass through directly; bound modalities are described by the bound model; unbound modalities get an explicit rejection message instead of reaching the model API.',
  multimodalDescriberImageLabel: 'Image Describer Model',
  multimodalDescriberAudioLabel: 'Audio Describer Model',
  multimodalDescriberVideoLabel: 'Video Describer Model',
  ...
  // Tail Tool
  tailTool: {
    title: 'Tail Tool Call',
    enableDesc: 'After each round ends, let the model additionally produce the configured tail tasks (e.g. follow-up suggestions) via the generic tail_tool, using the exact same context and model. Results are cache-friendly and never mixed into the main body',
    failMode: 'On missing call',
    failModeSilent: 'Fail silently',
    failModeMessage: 'Emit failure event',
    failModeDesc: 'What to do when the model does not call tail_tool',
    failMessage: 'Failure message',
    failMessagePlaceholder: 'e.g. Failed to generate suggestions',
    tasks: 'Tail Tasks',
    tasksDesc: 'Tasks the model should produce at the end of each round. Each task has a name and a specific usage instruction',
    taskNamePlaceholder: 'Select tool (task name)',
