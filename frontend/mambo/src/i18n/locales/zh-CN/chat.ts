export default {
  ...
  toolbar: {
    ...
    webSearchOff: '联网搜索：关闭',
    webSearchDirectRead: '联网搜索：仅读取网页（点击切换）',
    webSearchSearchAndRead: '联网搜索：搜索+读取（点击关闭）',
    chatPartition: '聊天分区',
    chatSettings: '会话设置',
    versionHistory: '版本历史',
    versionHistoryTip: '查看文件版本历史与变更记录',
    usageConversation: '主Agent会话总用量',
    usageActivePath: '主Agent当前激活路径',
    usageTotal: '总用量',
    usageCacheHit: '缓存命中',
    usageInput: '输入',
    usageOutput: '输出',
  ...
  message: {
    ...
    errorCancelled: '生成被用户取消。',
    errorUnhandled: '发生未处理的异常: {detail}',
    errorZipNoSummary: '模型未返回任何摘要内容',
    errorWebSearchCaptcha: 'DDG 返回了验证码页面，请稍后重试',
    errorWebSearchStrategy: '不支持的读取策略: {strategy}',
    errorModelConfigNotFound: '未能从全局设置 {keys} 中找到有效的模型配置',
    errorAgentModelNotFound: 'Agent 绑定的模型 {modelId} 不存在',
    errorNoModelConfigured: '会话未配置模型',
    showStack: '查看堆栈',
    hideStack: '收起堆栈',
