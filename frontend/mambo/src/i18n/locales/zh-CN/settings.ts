export default {
  ...
  about: {
    ...
    configuration: '配置',
    globalDesc: '语言、模型、编辑器偏好',
    providerDesc: '服务商与模型管理',
    mcpDesc: 'MCP 工具服务配置',
    resourceDesc: '资源与知识库管理',
  },
  avatar: {
    uploadTip: '点击上传新头像',
  ...
  global: {
    ...
    messageDisplay: '消息显示模式',
    messageDisplayTip: '控制 AI 消息中"思考"和"正文"的排列方式。',
    messageDisplayStacked: '堆叠（思考统一置顶）',
    messageDisplayInterleaved: '交错（思考+正文按时间顺序）',
    editorSimple: '普通文本框',
    ...
    dbMaintenance: '数据库维护',
    checkpointCleanup: '清理 Checkpoints 数据库',
    cleanupTip: '回收已删除会话占用的磁盘空间。清理期间将暂时无法发起新的对话，建议在空闲时执行。',
    cleanupBtn: '立即清理',
    cleanupReclaimable: '当前可回收约 {size}',
    cleanupDone: '清理完成，已回收 {size}',
    cleanupSkipped: '当前无需清理',
    cleanupFailed: '清理失败',
    cleanupTriggerFailed: '触发清理失败，请稍后重试',
    saving: '正在保存设置...',
    saved: '所有更改已保存',
    autoSave: '修改后自动保存',
